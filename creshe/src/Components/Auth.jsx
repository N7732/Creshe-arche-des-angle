...
export default function AuthModal({ isOpen, onClose, onSuccess }) {
  ...
  const handleGoogleSuccess = async (credentialResponse) => {
    ...
    setError('');
    try {
      const response = await fetch(`https://creshe-arche-des-angle-2.onrender.com/api/parents/google`, {
        method: 'POST',
  ...
  const handleSubmit = async (e) => {
    ...
    if (!isLogin) {
      ...
      try {
        const response = await fetch(`https://creshe-arche-des-angle-2.onrender.com/api/parents/register`, {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
    ...
    try {
      // 1. Try Parent Login
      const parentResponse = await fetch(`https://creshe-arche-des-angle-2.onrender.com/api/parents/login`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
      ...
      if (!parentResponse.ok) {
        ...
        const adminResponse = await fetch(`https://creshe-arche-des-angle-2.onrender.com/api/auth/login`, {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
