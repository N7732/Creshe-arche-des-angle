...
export default function About() {
  ...
  const { data: teamData } = useSWR('https://backend-creshe.onrender.com/api/team', fetcher);
  const { data: testimoniesData } = useSWR('https://backend-creshe.onrender.com/api/testimonies', fetcher);
