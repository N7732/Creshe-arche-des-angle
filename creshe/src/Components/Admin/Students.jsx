...
export default function Students() {
  ...
  const { data, error, isLoading } = useSWR(`https://creshe-arche-des-angle-2.onrender.com/api/enrollments`, fetcher);
  ...
  const updateStatus = async (id, newStatus) => {
    try {
      ...
      const res = await fetch(`https://creshe-arche-des-angle-2.onrender.com/api/enrollments/${id}/status`, {
        method: 'PUT',
        headers: { 
      ...
      mutate(`https://creshe-arche-des-angle-2.onrender.com/api/enrollments`);
    } catch (error) {
