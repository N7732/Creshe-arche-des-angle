...
export default function Guardians() {
  ...
  const { data, isLoading } = useSWR(`https://creshe-arche-des-angle-2.onrender.com/api/guardians`, fetcher);
  ...
  const handleSendEmail = async (e) => {
    ...
    setSendSuccess('');
    try {
      const res = await fetch(`https://creshe-arche-des-angle-2.onrender.com/api/guardians/send-email`, {
        method: 'POST',
